    ...
    "Rows":[
        {
            ...
            "InternalOrder":-3,
            "ArticleGroupId":8,
            "ArticleGroupIdExtended":8,
            "ProductEan":"7350106397331",
            "LatestChange":"2022-02-04T13:56:23Z",
            "OfflineId":"xxxxxxxx"
        }
    ],
...
var options = {
    url: 'https://handla.api.ica.se/api/user/offlineshoppinglists',  //Skapar en ny Inköpslista
    json: true,
    headers: headers,
    body: shoppingList
};
